...
const DeleteAbout = ({ isOpen, onClose, aboutData, updateAboutData }) => {
  ...
  const handleDelete = async (e) => {
    try {
      ...
      setToastMessage("About deleted successfully");
      setShowToast(true);
      onClose();
      updateAboutData();
    } catch (error) {
      ...
      <RockModal isOpen={isOpen} onClose={onClose} type="solid">
        <div className="p-4 text-center">
          <div className="text-black">
            <h2 className="text-xl font-bold mb-4">Delete Seminar</h2>
